...
> Contact create_contact_v2_contacts_post(contact_create)
...
------------- | ------------- | -------------
[**ContactCreate**](../../models/ContactCreate.md) |  | 
...
> Contact create_contact_v2_contacts_post_0(contact_create)
...
> Contact update_contact_v2_contacts_contact_id_put(contact_idcontact_update)
...
with versify.ApiClient(configuration) as api_client:
    ...
    body = ContactUpdate(
        ...
        metadata=dict(),
        name=None,
        owner="user_5f9f1c5b0b9b4b0b9c1c5b0b",
        phone_number="+1 555 555 5555",
        social_profiles=[],
    )
    try:
...
Type | Description  | Notes
------------- | ------------- | -------------
[**ContactUpdate**](../../models/ContactUpdate.md) |  | 
...
> Contact update_contact_v2_contacts_contact_id_put_0(contact_idcontact_update)
