...
class RedemptionService(ExpandableResource):
    ...
    def get(self, redemption_id: str) -> dict:
        ...
        Returns:
            dict: The redemption.
        """
        logging.info("Retrieving redemption", extra={"redemption_id": redemption_id})
    ...
    def update(self, redemption_id: str, body: dict) -> dict:
        ...
        """
        logging.info("Updating redemption", extra={"redemption_id": redemption_id})
    ...
    def delete(self, redemption_id: str) -> bool:
        ...
        deleted = self.collection.find_one_and_delete({"_id": redemption_id})
        if not deleted:
            raise NotFoundError
