...
from src.responses import (make_bad_request_error_response,
                           make_forbidden_error_response, make_get_response,
...
from versify.models.account import (AccountAdminResponse, AccountCreateRequest,
                                    AccountDeletedResponse,
                                    AccountListResponse, AccountMemberResponse,
                                    AccountPublicResponse,
                                    AccountUpdateRequest)
from versify.models.contact import (ContactCreateRequest,
                                    ContactDeletedResponse, ContactListFilter,
                                    ContactListQuery, ContactListResponse,
                                    ContactResponse, ContactUpdateRequest)
...
@app.route(f'/{API_VERSION}/accounts/<account_id>/contacts/<contact_id>', methods=['GET'])
@validate(on_success_status=200)
...
@app.route(f'/{API_VERSION}/accounts/<account_id>/contacts/<contact_id>', methods=['PUT'])
...
@app.route(f'/{API_VERSION}/accounts/<account_id>/contacts/<contact_id>', methods=['DELETE'])
@validate(on_success_status=200)
