...
class CollectionService(ExpandableResource):
    ...
    def create(self, body: dict) -> dict:
        ...
        Returns:
            dict: The account.
        """
        logger.info('Creating collection', extra={'body': body})
    ...
    def count(self, filter: dict) -> int:
        ...
        """
        logger.info('Counting collections', extra={'filter': filter})
    ...
    def list(self, filter: dict = {}, limit: int = 20, skip: int = 0) -> list:
        ...
        """
        logger.info('Listing collections', extra={'filter': filter})
    ...
    def update(self, collection_id: str, body: dict) -> dict:
        ...
        """
        logger.info('Updating collection', extra={'id': collection_id})
