...
SchemaFor201ResponseBodyApplicationJson = Account
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_account_v2_accounts_post_oapg(
        self,
...
class CreateAccountV2AccountsPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_account_v2_accounts_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_account_v2_accounts_post(
        ...
        return self._create_account_v2_accounts_post_oapg(
            body=body,
