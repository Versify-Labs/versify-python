...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_collection_v2_collections_collection_id_put_0_oapg(
        self,
...
class UpdateCollectionV2CollectionsCollectionIdPut0(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_collection_v2_collections_collection_id_put_0(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def update_collection_v2_collections_collection_id_put_0(
        ...
        return self._update_collection_v2_collections_collection_id_put_0_oapg(
            body=body,
