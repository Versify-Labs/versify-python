...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_current_user_v2_users_me_put_oapg(
        self,
...
class UpdateCurrentUserV2UsersMePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_current_user_v2_users_me_put(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def update_current_user_v2_users_me_put(
        ...
        return self._update_current_user_v2_users_me_put_oapg(
            body=body,
