...
class BaseApi(api_client.Api):
    @typing.overload
    def _authorize_v2_oauth_authorize_get_0_oapg(
        self,
...
class AuthorizeV2OauthAuthorizeGet0(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def authorize_v2_oauth_authorize_get_0(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def authorize_v2_oauth_authorize_get_0(
        ...
        return self._authorize_v2_oauth_authorize_get_0_oapg(
