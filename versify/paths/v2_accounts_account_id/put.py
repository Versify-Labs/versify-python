...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_account_v2_accounts_account_id_put_oapg(
        self,
...
class UpdateAccountV2AccountsAccountIdPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_account_v2_accounts_account_id_put(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_account_v2_accounts_account_id_put(
        ...
        return self._update_account_v2_accounts_account_id_put_oapg(
            body=body,
