...
class Tag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account", "_id", "created", "metadata", "object", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account", "_id", "created", "metadata", "object", "updated", ], str]):
