...
class Claim(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account", "asset", "code", "_id", "created", "metadata", "object", "quantity", "status", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account", "asset", "code", "_id", "created", "metadata", "object", "quantity", "status", "updated", ], str]):
