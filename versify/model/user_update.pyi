...
class UserUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["avatar", "metadata", "name", "phone_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["avatar", "metadata", "name", "phone_number", ], str]):
