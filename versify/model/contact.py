...
class Contact(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account", "email", "_id", "active", "address", "avatar", "browser", "created", "last_seen", "metadata", "name", "object", "owner", "phone_number", "social_profiles", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account", "email", "_id", "active", "address", "avatar", "browser", "created", "last_seen", "metadata", "name", "object", "owner", "phone_number", "social_profiles", "updated", ], str]):
