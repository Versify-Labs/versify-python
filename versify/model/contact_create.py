...
class ContactCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "address", "avatar", "metadata", "name", "phone_number", "social_profiles", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "address", "avatar", "metadata", "name", "phone_number", "social_profiles", ], str]):
