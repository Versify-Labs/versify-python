...
class ContactCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "metadata", "name", "phone_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "metadata", "name", "phone_number", ], str]):
