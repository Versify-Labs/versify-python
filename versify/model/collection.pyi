...
class Collection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account", "name", "_id", "active", "blockchain", "contract_address", "created", "default", "description", "image", "metadata", "object", "signature", "status", "transaction", "updated", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account", "name", "_id", "active", "blockchain", "contract_address", "created", "default", "description", "image", "metadata", "object", "signature", "status", "transaction", "updated", "uri", ], str]):
