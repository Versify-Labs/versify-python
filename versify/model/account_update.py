...
class AccountUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["brand", "domain", "metadata", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["brand", "domain", "metadata", "name", ], str]):
